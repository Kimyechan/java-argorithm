...
public class Main2 {
    ...
    private static void startGame(List<Integer> orders, String[][] board) {
        if (orders.size() == 10) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (positionRedForBlue == direction) {
                    isRedGoal = moveBead(red, direction, board);
                    isBlueGoal = moveBead(blue, direction, board);
                } else {
                    isBlueGoal = moveBead(blue, direction, board);
                    isRedGoal = moveBead(red, direction, board);
                }
    ...
    private static boolean moveBead(Bead bead, int direction, String[][] board) {
